              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(
                        Icons.person, size: 150, color: Colors.blue),
                  ),
                      ...
                      Expanded(
                        child: BlocBuilder<AuthBloc, AuthState>(
                          builder: (context, state) {
                            ...
                            final bool isButtonLoading = state is AuthLoading;
                                  ...
                                  return CustomButton(
                                    ...
                                    onPressed: isButtonLoading
                                      ...
                                      if (_usernameErrorText == null &&
                                        ...
                                        try {
                                          ...
                                          if (defaultTargetPlatform ==
                                            ...
                                            currentDeviceName = androidInfo.model;
                                              ...
                                              TargetPlatform.iOS) {
                                            IosDeviceInfo iosInfo = await deviceInfo
                                                .iosInfo;
                                            currentDeviceName = iosInfo.name;
                                          } else {
                                            currentDeviceName =
                                            'flutter_app_desktop'; // Diğer platformlar için
                                          }
                                        } catch (e) {
                                          print(
                                              "Cihaz adı alınırken hata oluştu (Login): $e");
                                        }
                                        ...
                                        _showSnackBar(
                                            "Lütfen giriş bilgilerinizi doğru girin.",
                                            isError: true);
                                      }
                                    },
                                  );
