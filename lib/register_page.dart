...
import 'package:login_page_flutter/verify_registration_email_page.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  // isLoading artık Bloc'tan yönetilecek
  // nullName, nullEmail, nullPassword, nullPassword2 gibi boolean'lar da Bloc tarafından yönetilebilir
  // veya sadece UI odaklı olarak bu sayfada kalabilir. Şimdilik burada kalsın.
  bool nullName = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocListener<AuthBloc, AuthState>( // AuthBloc'u dinle
                  ...
                  Container(
                    ...
                    child: BlocBuilder<AuthBloc, AuthState>( // Butonun durumunu AuthBloc'tan al
                      builder: (context, state) {
                        ...
                        return CustomButton(
                          text: isLoading ? "Gönderiliyor..." : "Kayıt Ol",
                          snackText: "",
                          snack: false,
                          isNavigation: false,
                          onPress: !isLoading,
                          callback: (value) async {
                            if (value == "ok" && !isLoading) {
                              ...
                              // Bloc'a RegisterRequested olayı gönder
